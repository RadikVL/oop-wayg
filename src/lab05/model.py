"""
Иерархия классов из ЛР-3, утащенная сюда чтоб ЛР-5 запускалась автономно.

Краткий пересказ: BankAccount + два наследника (CreditAccount, DepositAccount).
Подробности — в README ЛР-3.
"""
...
class BankAccount:
    ...
    def __init__(self, account_number, holder_name, balance=0.0, interest_rate=0.0):
    ...
    def __hash__(self): return hash(self._account_number)
...
class CreditAccount(BankAccount):
    ...
    def __init__(self, account_number, holder_name,
                 balance=0.0, interest_rate=0.0, credit_limit=0.0, debt=0.0):
...
class DepositAccount(BankAccount):
    ...
    def __init__(self, account_number, holder_name,
                 balance=0.0, interest_rate=0.0, term_months=12):
        super().__init__(account_number, holder_name, balance, interest_rate)
